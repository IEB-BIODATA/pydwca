...
from dwca.terms import OrganismID, OrganismName, OrganismScope, AssociatedOrganisms, PreviousIdentifications, \
    OrganismRemarks, Field


class Organism(DataFile):
    """
