...
from dwca.terms import Field, LocationID, DWCLocalityTerm, CountryCode, LifeStage, OccurrenceStatus, \
    DWCDegreeOfEstablishment, Pathway, ThreatStatus, AppendixCITES, EventDate, StartDayOfYear, EndDayOfYear, DWCSource, \
    OccurrenceRemarks, DWCDataset
from xml_common.utils import EstablishmentMeans


class Distribution(DataFile):
    """
    ...
    __field_class__ = DataFile.__field_class__ + [
        LocationID, DWCLocalityTerm, CountryCode, LifeStage,
        OccurrenceStatus, EstablishmentMeans, DWCDegreeOfEstablishment,
        Pathway, ThreatStatus, AppendixCITES, EventDate, StartDayOfYear,
        EndDayOfYear, DWCSource, OccurrenceRemarks, DWCDataset
    ]
