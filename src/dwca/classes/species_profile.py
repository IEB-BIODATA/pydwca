...
from dwca.terms import Field, IsMarine, IsFreshwater, IsTerrestrial, IsInvasive, IsHybrid, IsExtinct, LivingPeriod, \
    AgeInDays, SizeInMillimeters, MassInGrams, LifeForm, Habitat, SpeciesSex


class SpeciesProfile(DataFile):
    """
    A basic species profile with characteristics in addition to textural description which are covered by the description extension.
    ...
    __field_class__ = DataFile.__field_class__ + [
        IsMarine, IsFreshwater, IsTerrestrial, IsInvasive, IsHybrid,
        IsExtinct, LivingPeriod, AgeInDays, SizeInMillimeters, MassInGrams, LifeForm,
        Habitat, SpeciesSex
    ]
